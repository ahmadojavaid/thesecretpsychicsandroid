package com.jobesk.thesecretpsychics.TrimmerClasses;
...
import com.jobesk.thesecretpsychics.databinding.ActivityVideoTrimmerBinding;
...
public class VideoTrimmerActivity extends BaseActivity implements OnTrimVideoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mVideoTrimmer != null && path != null) {
            ...
            mVideoTrimmer.setMaxFileSize(500);
