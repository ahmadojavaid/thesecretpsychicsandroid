...
import com.jobesk.thesecretpsychics.AdvisorActivities.AdvisorCategories;
...
public class AdvisorCategoryAdapter extends RecyclerView.Adapter<AdvisorCategoryAdapter.MyViewHolder> {
    ...
    public AdvisorCategoryAdapter(Context context, ArrayList<CategoryModel> moviesList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        int width = AdvisorCategories.width / 2 - 30;
