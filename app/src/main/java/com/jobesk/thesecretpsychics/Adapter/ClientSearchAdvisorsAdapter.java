...
public class ClientSearchAdvisorsAdapter extends RecyclerView.Adapter<ClientSearchAdvisorsAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView chat_img, online_img;
        ImageView ic_video;
    ...
    public ClientSearchAdvisorsAdapter(Activity activity, Context context, ArrayList<ClientFavouriteAdvisors> arrayListPsychic) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        String isOnline = model.getIsOnline();

        if (isOnline.equalsIgnoreCase("1")) {
            holder.online_img.setImageResource(R.drawable.ic_online);
        } else {

            holder.online_img.setImageResource(R.drawable.ic_offline);
        }
