...
public class AdvisorProfileSetup extends AppCompatActivity {

    private TextView toolbar_title;
    private LinearLayout next_btn;
    private ImageView back_img;
    private String TAG = "AdvisorProfileSetup";
    private String textValue = "";
    private TextView text_tv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.advisor_profile_setup);
        ...
        toolbar_title.setText(getApplicationContext().getResources().getString(R.string.advisor_setup_profile));
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(AdvisorProfileSetup.this, AdvisorGeneralInfo.class);
                startActivity(i);
            }
        });
...
//            mParams.put("password", password);
            ...
            WebReq.get(getApplicationContext(), "getprofilesetup", mParams, new MyTextHttpResponseHandler());
    ...
    private class MyTextHttpResponseHandler extends JsonHttpResponseHandler {
        ...
        public void onStart() {
            super.onStart();
            GlobalClass.showLoading(AdvisorProfileSetup.this);
            Log.d(TAG, "onStart");
...
//                        Toast.makeText(AdvisorBecomeAdvisor.this, "" + message, Toast.LENGTH_SHORT).show();
                        ...
                        String message = mResponse.getString("statusMessage");
                        Toast.makeText(AdvisorProfileSetup.this, "" + message, Toast.LENGTH_SHORT).show();
                    }
