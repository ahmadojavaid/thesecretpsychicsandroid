...
public class AdvisorOrderingInstruction extends AppCompatActivity {
    ...
    private String TAG = "AdvisorOrderingInstruction";
    private String instruction;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.advisor_ordering_instruction);
        ...
        toolbar_title.setText(getApplicationContext().getResources().getString(R.string.ordering_instruction));
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (instruction.equals("")) {
                    Intent i = new Intent(AdvisorOrderingInstruction.this, AdvisorExperience.class);
                    startActivity(i);
                } else {
                    orderInstruction();
                }
    ...
    private void orderInstruction() {
        ...
        if (GlobalClass.isOnline(getApplicationContext()) == true) {
            ...
            mParams.put("instructionForOrder", instruction);
    ...
    private class MyTextHttpResponseHandler extends JsonHttpResponseHandler {
        ...
        public void onStart() {
            super.onStart();
            GlobalClass.showLoading(AdvisorOrderingInstruction.this);
            Log.d(TAG, "onStart");
            ...
            if (mResponse != null && mResponse.length() != 0) {
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        Toast.makeText(AdvisorOrderingInstruction.this, "" + message, Toast.LENGTH_SHORT).show();
                    }
