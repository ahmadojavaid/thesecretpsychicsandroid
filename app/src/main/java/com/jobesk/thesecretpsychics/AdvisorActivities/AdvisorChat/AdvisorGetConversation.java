...
import com.jobesk.thesecretpsychics.ClientActivities.Chat.ClientConversationAdapter;
...
public class AdvisorGetConversation extends AppCompatActivity {
    private ImageView back_img;
    private TextView toolbar_title, availableconnections;
    private String TAG = "AdvisorGetConversation";
    ...
    private AdvisorConversationAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new AdvisorConversationAdapter(AdvisorGetConversation.this, mUsersData);
...
//            mParams.put("user_id", UserID);
            ...
            WebReq.get(getApplicationContext(), "getConversationAdvisor?sentTo=" + AdvisorID, mParams, new MyTextHttpResponseHandlerOnlineUsers());
        } else {
    ...
    class MyTextHttpResponseHandlerOnlineUsers extends JsonHttpResponseHandler {
        ...
        public void onStart() {
            ...
            if (firstTime == true) {
                ...
                GlobalClass.showLoading(AdvisorGetConversation.this);
