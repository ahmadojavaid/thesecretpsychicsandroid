...
public class AdvisorFragCustomerSupport extends Fragment {
    ...
    private String TAG = "AdvisorFragCustomerSupport";
    ...
    private void sendSupportMsg() {
        ...
        if (GlobalClass.isOnline(getActivity()) == true) {
            ...
            WebReq.post(getActivity(), "support", mParams, new MyTextHttpResponseHandler());
