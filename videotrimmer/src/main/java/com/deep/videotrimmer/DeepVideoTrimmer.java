...
public class DeepVideoTrimmer extends FrameLayout implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
            ...
            viewButtonSave.setOnClickListener(new OnClickListener() {
                                                  ...
                                                  public void onClick(View view) {
                                                      ...
                                                      if (letUserProceed) {
                                                          ...
                                                          Toast.makeText(getContext(), getContext().getResources().getString(R.string.video_size_limit), Toast.LENGTH_SHORT).show();
 ...
 /*        Adjust the size of the video
    ...
    private void setTimeFrames() {
        ...
        mTextTimeFrame.setText(getContext().getResources().getString(R.string.triming_Frame_length) + " " + String.format("%s %s - %s %s", stringForTime(mStartPosition), seconds, stringForTime(mEndPosition), seconds));
    }
...
//        letUserProceed = getCroppedFileSize() < maxFileSize;
        ...
        if (mTimeVideo <= 180000) {
            letUserProceed = true;

        } else {
            letUserProceed = false;
        }


        Log.d("trimmingvalue", mTimeVideo + "    " + letUserProceed);
    ...
    private void getSizeFile(boolean isChanged) {
        if (isChanged) {
            ...
            mTextSize.setText(getContext().getResources().getString(R.string.video_size_with_colon) + "" + String.format("%s %s", newSize / 1024, getContext().getString(R.string.megabyte)));
        } else {
